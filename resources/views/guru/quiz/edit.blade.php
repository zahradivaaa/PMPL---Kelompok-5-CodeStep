...
<head>
    ...
    <title>Edit Quiz - CodeStep</title>
    ...
    <style>
        ...
        .page-heading { font-size: 1.75rem; font-weight: 800; color: var(--blue-dark); margin-bottom: .25rem; }

        /* Breadcrumb */
        .breadcrumb { display: flex; align-items: center; gap: .4rem; font-size: .85rem; color: var(--text-muted); margin-bottom: 1.75rem; }
        .breadcrumb a { color: var(--blue); font-weight: 500; }
        .breadcrumb a:hover { text-decoration: underline; }

        /* ── Form card ── */
        .form-card { background: var(--white); border: 1.5px solid var(--border); border-radius: 16px; padding: 2rem; margin-bottom: 2rem; }
        ...
        .radio-item { display: flex; align-items: center; gap: .6rem; font-size: .875rem; color: var(--text); cursor: pointer; }
        ...
        .btn-row { display: flex; justify-content: flex-end; gap: .75rem; margin-top: 1.75rem; padding-top: 1.5rem; border-top: 1px solid var(--border); }
        .btn-cancel {
        ...
        .btn-primary {
            ...
            font-size: .875rem; font-family: 'Poppins', sans-serif; font-weight: 600;
...
<div class="shell">
    ...
    <div class="main">
        ...
        <div class="page-content">
            ...
            <h1 class="page-heading">Edit Quiz</h1>

            {{-- Breadcrumb --}}
            <div class="breadcrumb">
                <a href="{{ route('guru.quiz.index') }}">Quiz</a>
                <span>›</span>
                <a href="{{ route('guru.quiz.show', $quiz->id) }}">{{ $quiz->judul }}</a>
                <span>›</span>
                <span>Edit</span>
            </div>
            ...
            <div class="form-card">
                <form action="{{ route('guru.quiz.update', $quiz->id) }}" method="POST">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" id="tanggal_mulai" name="tanggal_mulai"
                                ...
                                value="{{ old('tanggal_mulai', \Carbon\Carbon::parse($quiz->tanggal_mulai)->format('Y-m-d\TH:i')) }}">
                        ...
                        <div class="form-group full">
                            ...
                            <textarea id="deskripsi" name="deskripsi"
                                ...
                                placeholder="Deskripsi singkat tentang quiz ini...">{{ old('deskripsi', $quiz->deskripsi) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-group">
                                <label class="radio-item">
                                    <input type="radio" name="status" value="aktif" {{ old('status', $quiz->status) == 'aktif' ? 'checked' : '' }}>
                                    Aktif
                                </label>
                                <label class="radio-item">
                                    <input type="radio" name="status" value="draft" {{ old('status', $quiz->status) == 'draft' ? 'checked' : '' }}>
                                    Draft
                                </label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            @error('materi_id') <span class="invalid-feedback">{{ $message }}</span> @enderror
                        </div>
                    ...
                    {{-- Buttons --}}
                    <div class="btn-row">
                        <a href="{{ route('guru.quiz.show', $quiz->id) }}" class="btn-cancel">Batal</a>
